...
<script>
$(function() {
	$.post('<?php echo site_url('admin/catalog_item/order_ajax'); ?>', {}, function(data){
	...
	$('#save').click(function(){
		...
		$('#orderResult').slideUp(function(){
			$.post('<?php echo site_url('admin/catalog_item/order_ajax'); ?>', { sortable: oSortable }, function(data){
				$('#orderResult').html(data);
